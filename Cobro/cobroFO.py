...
nombre_estacionamiento = 'Insurgentes Sur 263'
...
class FormularioOperacion:
    ...
    def consulta_por_folio(self):
        ...
        # Botón "Promo SEMOVI"
        self.button_promo_SEMOVI = tk.Button(
            self.frame_promociones_botones,
            text="Promo\nPERSONAL DE SEMOVI",
            command=self.promo_SEMOVI,
            # width=10,
            height=2,
            anchor="center",
            bg="#FF8000",
        ...
        self.button_promo_SEMOVI.grid(column=0, row=0, padx=5, pady=5, sticky=tk.NSEW)
        self.labelpromo=tk.LabelFrame(self.frame_promociones, text="Leer el QR de Promocion")
        self.labelpromo.grid(column=0, row=1, padx=4, pady=4, sticky=tk.NW)
    ...
    def promo_SEMOVI(self, promo:str = "SEMOVI"):
        if self.folio.get() == "":
